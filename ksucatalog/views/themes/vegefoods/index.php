                ...
                <div class="col-lg-12 d-block">
                    <div class="row d-flex">
                        <div class="col-md pr-4 d-flex topper align-items-center">
                            ...
                            <a href="tel:+62123456789"><span class="text">+62 82341511467</span></a>
                        </div>

                        <div class="col-md pr-4 d-flex topper align-items-center">
                            <div class="icon mr-2 d-flex justify-content-center align-items-center"><span class="icon-paper-plane"></span></div>
                            <a href="mailto:emailanda@example.com"><span class="text" style="text-transform: lowercase;">ewibuahsumbawa@gmail.com</span></a>
                        </div>
            ...
            <div class="row mb-5">
                <div class="col-md">
                    <div class="ftco-footer-widget mb-4">
                        <h2 class="ftco-heading-2">Ewi Buah Sumbawa</h2>
                ...
                <div class="col-md-4">
                    <div class="ftco-footer-widget mb-4">
                        ...
                        <div class="block-23 mb-3">
                            <ul>
                                <li><span class="icon icon-map-marker"></span><span class="text">Jl. Hasanudin depan sd 2 sumbawa sebelum polres, Bugis, Kec. Sumbawa, Sumbawa besar, Nusa Tenggara Bar. 84312, Indonesia
                                <br>
                               </span></li>

                                <li><a href="tel:nomor_telepon_yang_diinginkan"><span class="icon icon-phone"></span><span class="text">082341511467</span></a></li>

                                <li><a href="mailto:email_yang_diinginkan"><span class="icon icon-envelope"></span><span class="text">ewibuahsumbawa@gmail.com</span></a></li>
            ...
            <div class="row" style="margin-bottom:-65px;">
                <div class="col-md-12 text-center">
                    ...
                    <p>
                        ...
                        Copyright by Mahyu &copy; <?=date('Y');?> All rights reserved
